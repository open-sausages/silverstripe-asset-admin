...
function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){return Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}var o=r(["fragment MyCustomFragment on File {\n      extension\n  }"],["fragment MyCustomFragment on File {\n      extension\n  }"]),l=n(2),a=n(3),s=i(a),u=n(4),d=i(u),p=n(5),c=i(p),f=n(6),h=i(f),m=n(9),g=i(m),y=n(12),v=i(y),b=n(14),E=i(b),F=n(40),_=i(F),A=n(43),T=i(A)


T["default"].addCustomFragment("ReadFiles","readFiles",(0,_["default"])(o)),document.addEventListener("DOMContentLoaded",function(){var e=s["default"].getSection("SilverStripe\\AssetAdmin\\Controller\\AssetAdmin")


d["default"].add({path:e.url,component:E["default"],indexRoute:{onEnter:function t(n,i){var r=[e.url,"show",0].join("/")
i(r)}},childRoutes:[{path:"show/:folderId/edit/:fileId",component:E["default"]},{path:"show/:folderId",component:E["default"]}]}),c["default"].add("assetAdmin",(0,l.combineReducers)({gallery:h["default"],
editor:v["default"],queuedFiles:g["default"]}))})},function(e,t){e.exports=Redux},function(e,t){e.exports=Config},function(e,t){e.exports=ReactRouteRegister},function(e,t){e.exports=ReducerRegister},function(e,t,n){
"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),f=o(["\n  query ReadFiles($id:ID!) {\n    readFiles(id: $id) {\n      ...FileInterfaceFields\n      ...FileFields\n      ...on Folder {\n        children {\n          ...FileInterfaceFields\n          ...FileFields\n        },\n        parents {\n          __typename\n          id\n          title\n        }\n      }\n    }\n  }\n  ","\n  ","\n"],["\n  query ReadFiles($id:ID!) {\n    readFiles(id: $id) {\n      ...FileInterfaceFields\n      ...FileFields\n      ...on Folder {\n        children {\n          ...FileInterfaceFields\n          ...FileFields\n        },\n        parents {\n          __typename\n          id\n          title\n        }\n      }\n    }\n  }\n  ","\n  ","\n"]),h=o(["mutation UpdateFile($id:ID!, $file:FileInput!) {\n  updateFile(id: $id, file: $file) {\n    id\n  }\n}"],["mutation UpdateFile($id:ID!, $file:FileInput!) {\n  updateFile(id: $id, file: $file) {\n    id\n  }\n}"]),m=o(["mutation DeleteFile($id:ID!) {\n  deleteFile(id: $id)\n}"],["mutation DeleteFile($id:ID!) {\n  deleteFile(id: $id)\n}"]),g=n(16),y=r(g),v=n(17),b=n(2),E=n(18),F=n(19),_=r(F),A=n(20),T=r(A),D=n(3),w=r(D),C=n(11),O=r(C),P=n(21),k=i(P),S=n(22),I=i(S),L=n(23),U=i(L),R=n(24),M=r(R),N=n(28),x=r(N),z=n(41),q=r(z),j=n(42),B=r(j),H=n(38),Q=n(40),W=r(Q),G=n(43),K=function(t){
function n(){l(this,n)
...
multiline:!0,crumbs:this.props.breadcrumbs})),y["default"].createElement("div",{className:"flexbox-area-grow fill-width gallery"},a,l))}}]),n}(_["default"])
K.propTypes={mutate:y["default"].PropTypes.func.isRequired,config:y["default"].PropTypes.shape({forms:y["default"].PropTypes.shape({editForm:y["default"].PropTypes.shape({schemaUrl:y["default"].PropTypes.string
...
var $=(0,W["default"])(f,x["default"].fragments.fileInterface,x["default"].fragments.file),V=(0,W["default"])(h),Z=(0,W["default"])(m)
t["default"]=(0,b.compose)((0,G.graphqlWithRegister)($,{options:function Y(e){return{variables:{id:e.params.folderId}}},props:function X(e){var t=e.data,n=t.loading,i=t.refetch,r=t.readFiles
return{loading:n,refetch:i,folder:r&&r[0]?r[0]:null,files:r&&r[0]?r[0].children:[]}}}),(0,H.graphql)(V),(0,H.graphql)(Z),function(e){return(0,H.withApollo)(e)},function(e){return(0,E.withRouter)(e)},(0,
v.connect)(u,d))(K)}).call(t,n(15))},function(e,t){e.exports=jQuery},function(e,t){e.exports=React},function(e,t){e.exports=ReactRedux},function(e,t){e.exports=ReactRouter},function(e,t){e.exports=SilverStripeComponent
...
return{count:n,selectedFiles:i,page:r,queuedFiles:e.assetAdmin.queuedFiles}}function p(e){return{actions:{gallery:(0,P.bindActionCreators)(H,e),queuedFiles:(0,P.bindActionCreators)(W,e)}}}Object.defineProperty(t,"__esModule",{
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),h=o(["\n   fragment FileInterfaceFields on FileInterface {\n    __typename\n    id\n    parentId\n    title\n    type\n    category\n    exists\n    name\n    filename\n    url\n    canView\n    canEdit\n    canDelete\n   }\n    "],["\n   fragment FileInterfaceFields on FileInterface {\n    __typename\n    id\n    parentId\n    title\n    type\n    category\n    exists\n    name\n    filename\n    url\n    canView\n    canEdit\n    canDelete\n   }\n    "]),m=o(["\n   fragment FileFields on File {\n    __typename\n    extension\n    size\n   }\n    "],["\n   fragment FileFields on File {\n    __typename\n    extension\n    size\n   }\n    "]),g=o(["mutation CreateFolder($folder:FolderInput!) {\n  createFolder(folder: $folder) {\n    ...FileInterfaceFields\n    ...FileFields\n  }\n  ","\n  ","\n}"],["mutation CreateFolder($folder:FolderInput!) {\n  createFolder(folder: $folder) {\n    ...FileInterfaceFields\n    ...FileFields\n  }\n  ","\n  ","\n}"]),y=n(15),v=r(y),b=n(11),E=r(b),F=n(16),_=r(F),A=n(29),T=r(A),D=n(30),w=r(D),C=n(17),O=n(18),P=n(2),k=n(31),S=r(k),I=n(3),L=r(I),U=n(32),R=r(U),M=n(35),N=r(M),x=n(36),z=r(x),q=n(25),j=r(q),B=n(21),H=i(B),Q=n(37),W=i(Q),G=n(38),K=n(39),$=r(K),V=n(40),Z=r(V),Y=t.Gallery=function(e){
function t(e){l(this,t)
var n=a(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
return n.sort="name",n.direction="asc",n.sorters=[{field:"title",direction:"asc",label:E["default"]._t("AssetAdmin.FILTER_TITLE_ASC")},{field:"title",direction:"desc",label:E["default"]._t("AssetAdmin.FILTER_TITLE_DESC")
},{field:"created",direction:"desc",label:E["default"]._t("AssetAdmin.FILTER_DATE_DESC")},{field:"created",direction:"asc",label:E["default"]._t("AssetAdmin.FILTER_DATE_ASC")}],n.handleFolderActivate=n.handleFolderActivate.bind(n),
...
className:"gallery__no-item-notice"},E["default"]._t("AssetAdmin.NOITEMSFOUND")):null}},{key:"getBackButton",value:function o(){var e=["btn","btn-secondary","btn--no-text","font-icon-level-up","btn--icon-large","gallery__back"].join(" ")
...
t.forEach(function(t){return e.props.onDelete(t.id)})},n=function l(t){e.props.onOpenFile(t[0])},i=j["default"].BULK_ACTIONS.map(function(e){return"delete"!==e.value||e.callback?"edit"!==e.value||e.callback?e:c({},e,{
callback:n}):c({},e,{callback:t})}),r=this.props.selectedFiles.map(function(t){return e.props.files.find(function(e){return t===e.id})})
return r.length>0&&this.props.bulkActions?_["default"].createElement(z["default"],{actions:i,items:r,key:r.length>0}):null}},{key:"getMoreButton",value:function p(){return this.props.count>this.props.files.length?_["default"].createElement("button",{
className:"gallery__load-more",onClick:this.handleMoreClick},E["default"]._t("AssetAdmin.LOADMORE")):null}},{key:"initSortDropdown",value:function h(){var e=(0,v["default"])(T["default"].findDOMNode(this)).find(".gallery__sort .dropdown")


e.chosen({allow_single_deselect:!0,disable_search_threshold:20}),e.off("change"),e.on("change",function(){return S["default"].Simulate.click(e.find(":selected")[0])})}},{key:"handleSort",value:function m(e){
...
}},{key:"handleSending",value:function F(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{xhr:t})}},{key:"handleUploadProgress",value:function A(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{
...
key:"handleFailedUpload",value:function O(e,t){this.props.actions.queuedFiles.failUpload(e._queuedAtTime,t)}},{key:"handleItemDelete",value:function P(e,t){this.props.onDelete([t.id])}},{key:"promptFolderName",
value:function k(){return prompt(E["default"]._t("AssetAdmin.PROMPTFOLDERNAME"))}},{key:"itemIsSelected",value:function I(e){return this.props.selectedFiles.indexOf(e)>-1}},{key:"itemIsHighlighted",value:function U(e){
return this.props.highlightedFiles.indexOf(e)>-1}},{key:"handleFolderActivate",value:function M(e,t){e.preventDefault(),this.props.onOpenFolder(t.id,t)}},{key:"handleFileActivate",value:function x(e,t){
e.preventDefault(),null!==t.created&&this.props.onOpenFile(t)}},{key:"handleToggleSelect",value:function q(e,t){this.props.selectedFiles.indexOf(t.id)===-1?this.props.actions.gallery.selectFiles([t.id]):this.props.actions.gallery.deselectFiles([t.id])
...
if(!this.props.folder)return this.props.errorMessage?_["default"].createElement("div",{className:"gallery__error"},_["default"].createElement("div",{className:"gallery__error-message"},_["default"].createElement("h3",null,this.props.errorMessage&&E["default"]._t("AssetAdmin.DROPZONE_RESPONSE_ERROR","Server responded with an error.")),_["default"].createElement("p",null,this.props.errorMessage))):_["default"].createElement("div",null)


var t={height:j["default"].THUMBNAIL_HEIGHT,width:j["default"].THUMBNAIL_WIDTH},n={url:this.props.createFileApiUrl,method:this.props.createFileApiMethod,paramName:"Upload",clickable:"#upload-button"},i=L["default"].get("SecurityID"),r=this.props.folder.canEdit


return _["default"].createElement("div",{className:"flexbox-area-grow gallery__outer"},_["default"].createElement(w["default"],{transitionName:"bulk-actions",transitionEnterTimeout:j["default"].CSS_TRANSITION_TIME,
transitionLeaveTimeout:j["default"].CSS_TRANSITION_TIME},this.getBulkActionsComponent()),_["default"].createElement("div",{className:"panel panel--padded panel--scrollable gallery__main"},_["default"].createElement("div",{
...
id:"upload-button",className:"btn btn-secondary font-icon-upload btn--icon-xl",type:"button",disabled:!r},_["default"].createElement("span",{className:"btn__text"},E["default"]._t("AssetAdmin.DROPZONE_UPLOAD"))),_["default"].createElement("button",{
...
},E["default"]._t("AssetAdmin.ADD_FOLDER_BUTTON")))),_["default"].createElement(R["default"],{canUpload:r,handleAddedFile:this.handleAddedFile,handleError:this.handleFailedUpload,handleSuccess:this.handleSuccessfulUpload,
...
return"folder"===t.type&&(i=_["default"].createElement(N["default"],{key:n,item:t,selected:e.itemIsSelected(t.id),highlighted:e.itemIsHighlighted(t.id),handleDelete:e.handleItemDelete,handleToggleSelect:e.handleToggleSelect,
handleActivate:e.handleFolderActivate})),i})),_["default"].createElement("div",{className:"gallery__files"},this.props.queuedFiles.items.map(function(t,n){return _["default"].createElement(N["default"],{
...
return"folder"!==t.type&&(i=_["default"].createElement(N["default"],{key:"file_"+n,item:t,selected:e.itemIsSelected(t.id),highlighted:e.itemIsHighlighted(t.id),handleDelete:e.handleItemDelete,handleToggleSelect:e.handleToggleSelect,
handleActivate:e.handleFileActivate})),i})),this.getNoItemsNotice(),_["default"].createElement("div",{className:"gallery__load"},this.getMoreButton()))))}}]),t}(F.Component)
Y.defaultProps={bulkActions:!0,files:[],selectedFiles:[],highlightedFiles:[]},Y.propTypes={client:_["default"].PropTypes.instanceOf($["default"]).isRequired,mutate:_["default"].PropTypes.func.isRequired,
...
actions:_["default"].PropTypes.object,sectionConfig:_["default"].PropTypes.shape({url:_["default"].PropTypes.string}),router:_["default"].PropTypes.object,errorMessage:_["default"].PropTypes.string},Y.fragments={
fileInterface:(0,Z["default"])(h),file:(0,Z["default"])(m)}
var X=(0,Z["default"])(g,Y.fragments.file,Y.fragments.fileInterface)
t.Gallery=Y,t["default"]=(0,P.compose)((0,G.graphql)(X),function(e){return(0,G.withApollo)(e)},function(e){return(0,O.withRouter)(e)},(0,C.connect)(d,p))(Y)},function(e,t){e.exports=ReactDom},function(e,t){
...
var o=i.get
if(void 0!==o)return o.call(n)},d=n(16),p=i(d),c=n(29),f=i(c),h=n(19),m=i(h),g=n(11),y=i(g),v=n(33),b=i(v),E=n(15),F=i(E),_=function(e){function t(e){r(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
this.props.uploadButton===!0&&(e.clickable=(0,F["default"])(f["default"].findDOMNode(this)).find(".asset-dropzone__upload-button")[0]),this.dropzone=new b["default"](f["default"].findDOMNode(this),a({},e,this.props.options)),
...
_.propTypes={folderId:p["default"].PropTypes.number.isRequired,handleAddedFile:p["default"].PropTypes.func.isRequired,handleDragEnter:p["default"].PropTypes.func,handleDragLeave:p["default"].PropTypes.func,
...
preview:p["default"].PropTypes.shape({width:p["default"].PropTypes.number,height:p["default"].PropTypes.number})},_.defaultProps={uploadButton:!0},t["default"]=_},function(e,t,n){(function(e,t){(function(){
...
var i,o,l,a,s,u,d,p,c,f,h,m,g,y,v,b,E,F,_,A,T,D,w,C,O,P,k,S,I,L,U,R,M,N
for(_=new XMLHttpRequest,A=0,C=e.length;A<C;A++)i=e[A],i.xhr=_
m=r(this.options.method,e),E=r(this.options.url,e),_.open(m,E,!0),_.withCredentials=!!this.options.withCredentials,v=null,l=function(t){return function(){var n,r,o
for(o=[],n=0,r=e.length;n<r;n++)i=e[n],o.push(t._errorProcessing(e,v||t.options.dictResponseError.replace("{{statusCode}}",_.status),_))
...
return c}}(this),_.onload=function(n){return function(i){var r
if(e[0].status!==t.CANCELED&&4===_.readyState){if(v=_.responseText,_.getResponseHeader("content-type")&&~_.getResponseHeader("content-type").indexOf("application/json"))try{v=JSON.parse(v)}catch(o){i=o,
v="Invalid JSON response from server."}return b(),200<=(r=_.status)&&r<300?n._finished(e,v,i):l()}}}(this),_.onerror=function(n){return function(){if(e[0].status!==t.CANCELED)return l()}}(this),y=null!=(I=_.upload)?I:_,
...
for(a in u)s=u[a],s&&_.setRequestHeader(a,s)
if(o=new FormData,this.options.params){L=this.options.params
for(h in L)F=L[h],o.append(h,F)}for(T=0,O=e.length;T<O;T++)i=e[T],this.emit("sending",i,_,o)
if(this.options.uploadMultiple&&this.emit("sendingmultiple",e,_,o),"FORM"===this.element.tagName)for(U=this.element.querySelectorAll("input, textarea, select, button"),D=0,P=U.length;D<P;D++)if(p=U[D],
...
return this.submitRequest(_,o,e)},t.prototype.submitRequest=function(e,t,n){return e.send(t)},t.prototype._finished=function(e,n,i){var r,o,l
...
value:function b(){return this.props.item.exists}},{key:"uploading",value:function E(){return this.props.uploading}},{key:"isImageSmallerThanThumbnail",value:function F(){if(!this.isImage()||!this.exists()&&!this.uploading())return!1
...
e.exports=GraphQLRegister},function(e,t){}])
