...
n(1),n(42)},function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{"default":e}}var r=n(2),o=n(3),l=i(o),a=n(4),s=i(a),u=n(5),d=i(u),p=n(6),c=i(p),f=n(9),h=i(f),m=n(12),g=i(m),y=n(14),v=i(y),b=n(41),E=i(b)
...
i(r)}},childRoutes:[{path:"show/:folderId/edit/:fileId",component:v["default"]},{path:"show/:folderId",component:v["default"]}],queries:{ReadFilesRelayRoute:E["default"]}}),d["default"].add("assetAdmin",(0,
r.combineReducers)({gallery:c["default"],editor:g["default"],queuedFiles:h["default"]}))})},function(e,t){e.exports=Redux},function(e,t){e.exports=Config},function(e,t){e.exports=ReactRouteRegister},function(e,t){
...
return{file:r,breadcrumbs:e.breadcrumbs,sectionConfig:i,limit:i.limit}}function d(e){return{actions:{gallery:(0,y.bindActionCreators)(O,e),editor:(0,y.bindActionCreators)(k,e),breadcrumbsActions:(0,y.bindActionCreators)(I,e)
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),f=o(["fragment on FileInterface {\n\t\t    __typename\n\t\t    id\n\t\t    parentId\n\t\t    title\n\t\t    type\n\t\t    category\n\t\t    exists\n\t\t    name\n\t\t    filename\n\t\t    url\n\t\t    canView\n\t\t    canEdit\n\t\t    canDelete\n\t    }"],["fragment on FileInterface {\n\t\t    __typename\n\t\t    id\n\t\t    parentId\n\t\t    title\n\t\t    type\n\t\t    category\n\t\t    exists\n\t\t    name\n\t\t    filename\n\t\t    url\n\t\t    canView\n\t\t    canEdit\n\t\t    canDelete\n\t    }"]),h=n(16),m=r(h),g=n(17),y=n(2),v=n(18),b=n(19),E=r(b),_=n(20),F=r(_),A=n(3),T=r(A),w=n(11),D=r(w),C=n(21),O=i(C),P=n(22),k=i(P),S=n(23),I=i(S),L=n(24),U=r(L),R=n(28),N=r(R),M=n(38),x=r(M),j=n(39),z=r(j),q=n(40),B=r(q),H=function(t){
function n(){l(this,n)
...
var t=T["default"].getSection("SilverStripe\\AssetAdmin\\Controller\\AssetAdmin")
...
return F["default"].createEndpointFetcher(p({},e,t?{defaultData:{SecurityID:T["default"].get("SecurityID")}}:{}))}},{key:"componentWillReceiveProps",value:function r(e){var t=this.compare(this.props.folder,e.folder)
...
key:"setBreadcrumbs",value:function u(e){var t=this.props.sectionConfig.url,n=[{text:D["default"]._t("AssetAdmin.FILES","Files"),href:"/"+t+"/"}]
...
this.props.router.push("/"+t+"/show/"+this.props.folder.id+"/edit/"+e)}},{key:"handleSubmitEditor",value:function g(e,t,n){var i=this
e.preventDefault(),n().then(function(e){return i.props.actions.gallery.loadFile(i.props.file.id,e.record),e})}},{key:"handleCloseFile",value:function y(){this.handleOpenFolder(this.props.folder.id)}},{
...
var o=this.props.file&&m["default"].createElement(U["default"],{file:this.props.file,onClose:this.handleCloseFile,editFileSchemaUrl:t.form.FileEditForm.schemaUrl,actions:this.props.actions.editor,onSubmit:this.handleSubmitEditor,
onDelete:this.handleDelete,addToCampaignSchemaUrl:t.form.AddToCampaignForm.schemaUrl}),l=this.props.folder&&m["default"].createElement(N["default"],{files:this.props.files,fileId:this.props.params.fileId,
...
return m["default"].createElement("div",{className:"fill-height cms-gallery no-preview collapse in"},m["default"].createElement(z["default"],{showBackButton:a,handleBackButtonClick:this.handleBackButtonClick
},m["default"].createElement(x["default"],{multiline:!0,crumbs:this.props.breadcrumbs})),m["default"].createElement("div",{className:"flexbox-area-grow fill-width gallery"},o,l))}}]),n}(E["default"])
H.propTypes={mutate:m["default"].PropTypes.func.isRequired,config:m["default"].PropTypes.shape({forms:m["default"].PropTypes.shape({editForm:m["default"].PropTypes.shape({schemaUrl:m["default"].PropTypes.string
})})}),sectionConfig:m["default"].PropTypes.shape({url:m["default"].PropTypes.string}),file:m["default"].PropTypes.object,files:m["default"].PropTypes.array,folder:m["default"].PropTypes.shape({id:m["default"].PropTypes.number,
title:m["default"].PropTypes.string,parents:m["default"].PropTypes.array,parentID:m["default"].PropTypes.number,canView:m["default"].PropTypes.bool,canEdit:m["default"].PropTypes.bool})},t["default"]=B["default"].createContainer((0,
y.compose)(function(e){return(0,v.withRouter)(e)},(0,g.connect)(u,d))(H),{fragments:{files:function Q(){return B["default"].QL(f)}}})}).call(t,n(15))},function(e,t){e.exports=jQuery},function(e,t){e.exports=React

},function(e,t){e.exports=ReactRedux},function(e,t){e.exports=ReactRouter},function(e,t){e.exports=SilverStripeComponent},function(e,t){e.exports=Backend},function(e,t,n){"use strict"
...
if(r<o)return 1}return 0}}function u(e){var t=e.assetAdmin.gallery,n=t.count,i=t.selectedFiles,r=t.page,o=t.errorMessage
return{count:n,selectedFiles:i,page:r,queuedFiles:e.assetAdmin.queuedFiles}}function d(e){return{actions:{gallery:(0,w.bindActionCreators)(j,e),queuedFiles:(0,w.bindActionCreators)(q,e)}}}Object.defineProperty(t,"__esModule",{
value:!0}),t.Gallery=void 0
var p=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e},c=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),f=n(15),h=r(f),m=n(11),g=r(m),y=n(16),v=r(y),b=n(29),E=r(b),_=n(30),F=r(_),A=n(17),T=n(18),w=n(2),D=n(31),C=r(D),O=n(3),P=r(O),k=n(32),S=r(k),I=n(35),L=r(I),U=n(36),R=r(U),N=n(26),M=r(N),x=n(21),j=i(x),z=n(37),q=i(z),B=t.Gallery=function(e){
...
c(t,[{key:"componentWillUpdate",value:function n(){var e=(0,h["default"])(E["default"].findDOMNode(this)).find(".gallery__sort .dropdown")
e.off("change")}},{key:"componentDidUpdate",value:function i(e){var t=(0,h["default"])(E["default"].findDOMNode(this)).find(".gallery__sort .dropdown")
t.chosen({allow_single_deselect:!0,disable_search_threshold:20}),t.on("change",function(){return C["default"].Simulate.click(t.find(":selected")[0])})}},{key:"getNoItemsNotice",value:function r(){return this.props.files.length<1&&this.props.queuedFiles.items.length<1&&!this.props.loading?v["default"].createElement("p",{
className:"gallery__no-item-notice"},g["default"]._t("AssetAdmin.NOITEMSFOUND")):null}},{key:"getBackButton",value:function u(){var e=["btn","btn-secondary","btn--no-text","font-icon-level-up","btn--icon-large","gallery__back"].join(" ")


return null!==this.props.folder.parentID?v["default"].createElement("button",{className:e,onClick:this.handleBackClick,ref:"backButton"}):null}},{key:"getBulkActionsComponent",value:function d(){var e=this,t=function o(t){
t.forEach(function(t){return e.props.onDelete(t.id)})},n=function l(t){e.props.onOpenFile(t[0].id)},i=M["default"].BULK_ACTIONS.map(function(e){return"delete"!==e.value||e.callback?"edit"!==e.value||e.callback?e:p({},e,{
callback:n}):p({},e,{callback:t})}),r=this.props.selectedFiles.map(function(t){return e.props.files.find(function(e){return t===e.id})})
return r.length>0&&this.props.bulkActions?v["default"].createElement(R["default"],{actions:i,items:r,key:r.length>0}):null}},{key:"getMoreButton",value:function f(){return this.props.count>this.props.files.length?v["default"].createElement("button",{
className:"gallery__load-more",onClick:this.handleMoreClick},g["default"]._t("AssetAdmin.LOADMORE")):null}},{key:"handleSort",value:function m(e){var t=e.target.dataset
this.props.actions.queuedFiles.purgeUploadQueue(),this.props.actions.gallery.sortFiles(s(t.field,t.direction))}},{key:"handleCancelUpload",value:function y(e){e.xhr.abort(),this.props.actions.queuedFiles.removeQueuedFile(e.queuedAtTime)

}},{key:"handleRemoveErroredUpload",value:function b(e){this.props.actions.queuedFiles.removeQueuedFile(e.queuedAtTime)}},{key:"handleAddedFile",value:function _(e){this.props.actions.queuedFiles.addQueuedFile(e)

}},{key:"handleSending",value:function A(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{xhr:t})}},{key:"handleUploadProgress",value:function T(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{
...
}},{key:"handleSuccessfulUpload",value:function D(e){var t=JSON.parse(e.xhr.response)
...
key:"handleFailedUpload",value:function O(e,t){this.props.actions.queuedFiles.failUpload(e._queuedAtTime,t)}},{key:"handleItemDelete",value:function k(e,t){this.props.onDelete([t.id])}},{key:"promptFolderName",
value:function I(){return prompt(g["default"]._t("AssetAdmin.PROMPTFOLDERNAME"))}},{key:"itemIsSelected",value:function U(e){return this.props.selectedFiles.indexOf(e)>-1}},{key:"itemIsHighlighted",value:function N(e){
return this.props.fileId===e}},{key:"handleFolderActivate",value:function x(e,t){e.preventDefault(),this.props.onOpenFolder(t.id,t)}},{key:"handleFileActivate",value:function j(e,t){e.preventDefault(),
null!==t.created&&this.props.onOpenFile(t.id,t)}},{key:"handleToggleSelect",value:function z(e,t){this.props.selectedFiles.indexOf(t.id)===-1?this.props.actions.gallery.selectFiles([t.id]):this.props.actions.gallery.deselectFiles([t.id])

}},{key:"handleMoreClick",value:function q(e){e.stopPropagation(),e.preventDefault(),this.props.actions.gallery.deselectFiles()}},{key:"handleBackClick",value:function B(e){e.preventDefault()
...
var t={height:M["default"].THUMBNAIL_HEIGHT,width:M["default"].THUMBNAIL_WIDTH},n={url:this.props.createFileApiUrl,method:this.props.createFileApiMethod,paramName:"Upload",clickable:"#upload-button"},i=P["default"].get("SecurityID"),r=this.props.folder.canEdit


return v["default"].createElement("div",{className:"flexbox-area-grow gallery__outer"},v["default"].createElement(F["default"],{transitionName:"bulk-actions",transitionEnterTimeout:M["default"].CSS_TRANSITION_TIME,
transitionLeaveTimeout:M["default"].CSS_TRANSITION_TIME},this.getBulkActionsComponent()),v["default"].createElement("div",{className:"panel panel--padded panel--scrollable gallery__main"},v["default"].createElement("div",{
...
},g["default"]._t("AssetAdmin.ADD_FOLDER_BUTTON")))),v["default"].createElement(S["default"],{canUpload:r,handleAddedFile:this.handleAddedFile,handleError:this.handleFailedUpload,handleSuccess:this.handleSuccessfulUpload,
handleSending:this.handleSending,handleUploadProgress:this.handleUploadProgress,preview:t,folderId:this.props.folder.id,options:n,securityID:i,uploadButton:!1},v["default"].createElement("div",{className:"gallery__folders"
...
B.defaultProps={bulkActions:!0,files:[]},B.propTypes={count:v["default"].PropTypes.number,fileId:v["default"].PropTypes.number,folder:v["default"].PropTypes.shape({id:v["default"].PropTypes.number,parentID:v["default"].PropTypes.number,
canView:v["default"].PropTypes.bool,canEdit:v["default"].PropTypes.bool}),files:v["default"].PropTypes.array,selectedFiles:v["default"].PropTypes.arrayOf(v["default"].PropTypes.number),bulkActions:v["default"].PropTypes.bool,
limit:v["default"].PropTypes.number,page:v["default"].PropTypes.number,queuedFiles:v["default"].PropTypes.shape({items:v["default"].PropTypes.array.isRequired}),onOpenFile:v["default"].PropTypes.func.isRequired,
onOpenFolder:v["default"].PropTypes.func.isRequired,createFileApiUrl:v["default"].PropTypes.string,createFileApiMethod:v["default"].PropTypes.string,onDelete:v["default"].PropTypes.func,actions:v["default"].PropTypes.object,
sectionConfig:v["default"].PropTypes.shape({url:v["default"].PropTypes.string}),router:v["default"].PropTypes.object},t.Gallery=B,t["default"]=(0,w.compose)(function(e){return(0,T.withRouter)(e)},(0,A.connect)(u,d))(B)
...
i({width:e.naturalWidth,height:e.naturalHeight,thumbnailURL:s})},e.src=t})}},{key:"handleError",value:function w(e,t){"function"==typeof this.props.handleError&&this.props.handleError(e,t)}},{key:"handleSuccess",
value:function D(e){this.props.handleSuccess(e)}},{key:"setPromptOnRemove",value:function C(e){this.dropzone.options.dictRemoveFileConfirmation=e}}]),t}(m["default"])
...
var i,o,l,a,s,u,d,p,c,f,h,m,g,y,v,b,E,_,F,A,T,w,D,C,O,P,k,S,I,L,U,R,N,M
...
for(h in L)_=L[h],o.append(h,_)}for(T=0,O=e.length;T<O;T++)i=e[T],this.emit("sending",i,F,o)
if(this.options.uploadMultiple&&this.emit("sendingmultiple",e,F,o),"FORM"===this.element.tagName)for(U=this.element.querySelectorAll("input, textarea, select, button"),w=0,P=U.length;w<P;w++)if(p=U[w],
c=p.getAttribute("name"),f=p.getAttribute("type"),"SELECT"===p.tagName&&p.hasAttribute("multiple"))for(R=p.options,D=0,k=R.length;D<k;D++)g=R[D],g.selected&&o.append(c,g.value)
else(!f||"checkbox"!==(N=f.toLowerCase())&&"radio"!==N||p.checked)&&o.append(c,p.value)
for(d=S=0,M=e.length-1;0<=M?S<=M:S>=M;d=0<=M?++S:--S)o.append(this._getParamName(d),e[d],this._renameFilename(e[d].name))
...
e.stopPropagation(),this.hasError()?this.props.handleRemoveErroredUpload(this.props.item):this.props.handleCancelUpload(this.props.item)}},{key:"getProgressBar",value:function w(){var e=null,t={className:"gallery-item__progress-bar",
...
var d=n(10),p=i(d)},function(e,t){e.exports=Breadcrumb},function(e,t){e.exports=Toolbar},function(e,t){e.exports=ReactRelay},function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){return Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")

}function l(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{
value:!0})
var s=r(["query {\n\t    readFiles(id: $id) { ","\n    "],["query {\n\t    readFiles(id: $id) { ","\n    "]),u=n(40),d=i(u),p=function(e){function t(){return o(this,t),l(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))

}return a(t,e),t}(d["default"].Route)
p.queries={files:function c(e){return d["default"].QL(s,e.getFragment("files"))}},p.paramDefinitions={id:{required:!0}},p.routeName="ReadFiles",t["default"]=p},function(e,t){}])
