...
n(1),n(15)},function(e,t,n){"use strict"
...
this.props.router.push("/"+t+"/show/"+e.parentId+"/edit/"+e.id)}},{key:"prepDataForGraphQL",value:function m(e){var t=[]
return Object.keys(e).map(function(n){var i=e[n]
t.push({name:n,value:i})}),t}},{key:"handleSubmitEditor",value:function g(e,t,n){this.props.updateFile({variables:{data:this.prepDataForGraphQL(e),action:t}}).then(function(e){var t=e.data
console.log("got data",t)})}},{key:"handleCloseFile",value:function v(){this.handleOpenFolder(this.props.folder)}},{key:"handleOpenFolder",value:function b(e){var t=this.props.sectionConfig.url
this.props.router.push("/"+t+"/show/"+e.id)}},{key:"handleDelete",value:function E(e){var t=this,n=this.props.files.find(function(t){return t.id===e})
...
this.props.deleteFile({mutation:"DeleteFile",variables:{id:n.id},resultBehaviors:[{type:"DELETE",dataId:r}]}).then(function(){t.props.actions.gallery.deselectFiles([n.id])
var e=t.props.sectionConfig.url,r=!(!t.props.file||n.id!==t.props.file.id),o=!(!t.props.folder||n.id!==t.props.folder.id);(r||o)&&t.props.router.push("/"+e+"/show/"+i)})}},{key:"render",value:function _(){
...
t["default"]=(0,b.compose)((0,H.graphql)(K,{options:function Z(e){return{variables:{id:e.params.folderId}}},props:function Y(e){var t=e.data,n=t.loading,i=t.refetch,r=t.readFiles
return{loading:n,refetch:i,folder:r&&r[0]?r[0]:null,files:r&&r[0]?r[0].children:[]}}}),(0,H.graphql)($,{name:"updateFile"}),(0,H.graphql)(V,{name:"deleteFile"}),function(e){return(0,H.withApollo)(e)},function(e){
return(0,E.withRouter)(e)},(0,v.connect)(u,d))(G)}).call(t,n(16))},function(e,t){},function(e,t){e.exports=jQuery},function(e,t){e.exports=React},function(e,t){e.exports=ReactRedux},function(e,t){e.exports=ReactRouter

},function(e,t){e.exports=SilverStripeComponent},function(e,t){e.exports=Backend},function(e,t,n){"use strict"
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),s=n(11),u=i(s),d=n(17),p=i(d),c=n(26),f=i(c),h=n(27),m=i(h),g=n(28),y=i(g),v=function(e){
...
return{count:n,selectedFiles:i,page:r,queuedFiles:e.assetAdmin.queuedFiles}}function p(e){return{actions:{gallery:(0,C.bindActionCreators)(j,e),queuedFiles:(0,C.bindActionCreators)(H,e)}}}Object.defineProperty(t,"__esModule",{
...
f(t,[{key:"componentDidMount",value:function n(){this.initSortDropdown()}},{key:"componentDidUpdate",value:function i(){this.initSortDropdown()}},{key:"getNoItemsNotice",value:function r(){return this.props.files.length<1&&this.props.queuedFiles.items.length<1&&!this.props.loading?E["default"].createElement("p",{
className:"gallery__no-item-notice"},v["default"]._t("AssetAdmin.NOITEMSFOUND")):null}},{key:"getBackButton",value:function o(){var e=["btn","btn-secondary","btn--no-text","font-icon-level-up","btn--icon-large","gallery__back"].join(" ")


return null!==this.props.folder.parentID?E["default"].createElement("button",{className:e,onClick:this.handleBackClick,ref:"backButton"}):null}},{key:"getBulkActionsComponent",value:function d(){var e=this,t=function o(t){
t.forEach(function(t){return e.props.onDelete(t.id)})},n=function l(t){e.props.onOpenFile(t[0])},i=z["default"].BULK_ACTIONS.map(function(e){return"delete"!==e.value||e.callback?"edit"!==e.value||e.callback?e:c({},e,{
callback:n}):c({},e,{callback:t})}),r=this.props.selectedFiles.map(function(t){return e.props.files.find(function(e){return t===e.id})})
return r.length>0&&this.props.bulkActions?E["default"].createElement(N["default"],{actions:i,items:r,key:r.length>0}):null}},{key:"getMoreButton",value:function p(){return this.props.count>this.props.files.length?E["default"].createElement("button",{
className:"gallery__load-more",onClick:this.handleMoreClick},v["default"]._t("AssetAdmin.LOADMORE")):null}},{key:"initSortDropdown",value:function h(){var e=(0,g["default"])(F["default"].findDOMNode(this)).find(".gallery__sort .dropdown")


e.chosen({allow_single_deselect:!0,disable_search_threshold:20}),e.off("change"),e.on("change",function(){return O["default"].Simulate.click(e.find(":selected")[0])})}},{key:"handleSort",value:function m(e){
var t=e.target.dataset
this.props.actions.queuedFiles.purgeUploadQueue(),this.props.actions.gallery.sortFiles(u(t.field,t.direction))}},{key:"handleCancelUpload",value:function y(e){e.xhr.abort(),this.props.actions.queuedFiles.removeQueuedFile(e.queuedAtTime)
...
}},{key:"handleSending",value:function A(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{xhr:t})}},{key:"handleUploadProgress",value:function D(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{
...
key:"handleFailedUpload",value:function P(e,t){this.props.actions.queuedFiles.failUpload(e._queuedAtTime,t)}},{key:"handleItemDelete",value:function k(e,t){this.props.onDelete([t.id])}},{key:"promptFolderName",
value:function I(){return prompt(v["default"]._t("AssetAdmin.PROMPTFOLDERNAME"))}},{key:"itemIsSelected",value:function U(e){return this.props.selectedFiles.indexOf(e)>-1}},{key:"itemIsHighlighted",value:function M(e){
return this.props.highlightedFiles.indexOf(e)>-1}},{key:"handleFolderActivate",value:function x(e,t){e.preventDefault(),this.props.onOpenFolder(t.id,t)}},{key:"handleFileActivate",value:function q(e,t){
...
},v["default"]._t("AssetAdmin.ADD_FOLDER_BUTTON")))),E["default"].createElement(L["default"],{canUpload:r,handleAddedFile:this.handleAddedFile,handleError:this.handleFailedUpload,handleSuccess:this.handleSuccessfulUpload,
...
V.defaultProps={bulkActions:!0,files:[],selectedFiles:[],highlightedFiles:[]},V.propTypes={client:E["default"].PropTypes.instanceOf(G["default"]).isRequired,mutate:E["default"].PropTypes.func.isRequired,
loading:E["default"].PropTypes.bool,count:E["default"].PropTypes.number,folder:E["default"].PropTypes.shape({id:E["default"].PropTypes.number,parentID:E["default"].PropTypes.number,canView:E["default"].PropTypes.bool,
canEdit:E["default"].PropTypes.bool}),files:E["default"].PropTypes.array,highlightedFiles:E["default"].PropTypes.arrayOf(E["default"].PropTypes.number),selectedFiles:E["default"].PropTypes.arrayOf(E["default"].PropTypes.number),
bulkActions:E["default"].PropTypes.bool,limit:E["default"].PropTypes.number,page:E["default"].PropTypes.number,queuedFiles:E["default"].PropTypes.shape({items:E["default"].PropTypes.array.isRequired}),
onOpenFile:E["default"].PropTypes.func.isRequired,onOpenFolder:E["default"].PropTypes.func.isRequired,createFileApiUrl:E["default"].PropTypes.string,createFileApiMethod:E["default"].PropTypes.string,onDelete:E["default"].PropTypes.func,
actions:E["default"].PropTypes.object,sectionConfig:E["default"].PropTypes.shape({url:E["default"].PropTypes.string}),router:E["default"].PropTypes.object,errorMessage:E["default"].PropTypes.string}
var Z=(0,$["default"])(h)
t.Gallery=V,t["default"]=(0,C.compose)((0,Q.graphql)(Z),function(e){return(0,Q.withApollo)(e)},function(e){return(0,w.withRouter)(e)},(0,D.connect)(d,p))(V)},function(e,t){e.exports=ReactDom},function(e,t){
...
var o=i.get
if(void 0!==o)return o.call(n)},d=n(17),p=i(d),c=n(30),f=i(c),h=n(20),m=i(h),g=n(11),y=i(g),v=n(34),b=i(v),E=n(16),_=i(E),F=function(e){function t(e){r(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
i[n](a+"readystatechange",o,!1),e[n](a+"load",o,!1)}},n._autoDiscoverFunction=function(){if(n.autoDiscover)return n.discover()},o(window,n._autoDiscoverFunction)}).call(this)}).call(t,n(16),n(35)(e))},function(e,t){
...
value:!0})
var a=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),s=n(11),u=i(s),d=n(17),p=i(d),c=n(26),f=i(c),h=n(20),m=i(h),g=function(e){
function t(e){r(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),u=n(16),d=i(u),p=n(17),c=i(p),f=n(30),h=i(f),m=n(20),g=i(m),y=n(32),v=i(y),b=n(18),E=t.BulkActions=function(e){
function t(e){r(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
var d=n(10),p=i(d)},function(e,t){e.exports=ReactApollo},function(e,t){e.exports=ApolloClient},function(e,t){e.exports=GraphQLTag},function(e,t){e.exports=Breadcrumb},function(e,t){e.exports=Toolbar}])
